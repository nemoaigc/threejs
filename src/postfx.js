...
const OutlineShader = {
  uniforms: {
    ...
    uDepthBias: { value: 0.0018 },
    uNormalBias: { value: 0.55 },
    uSketch: { value: 0.15 },
    uOutlineColor: { value: new THREE.Color(0x2a2430) },
  },
  vertexShader: /* glsl */ `
    varying vec2 vUv;
...
const GradeShader = {
  ...
  fragmentShader: /* glsl */ `
    ...
    void main(){
      ...
      // soft posterize (mix quantized with original → no hard muddy steps)
